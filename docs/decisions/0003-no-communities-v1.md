...
## Decision
I will **defer the Communities feature to V2**. V1 will rely entirely on a unified Global Feed and a Tag-based taxonomy (e.g., `#react`, `#system-design`) rather than walled gardens.
...
- **Negative:** I lose the "private group" feel initially, requiring users to rely on search and tags to find their niche.
